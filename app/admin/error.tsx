  ...
  return (
    <main className="min-h-screen bg-[#faf7f0] flex flex-col items-center justify-center p-6 text-center font-sans">
      <div className="max-w-md w-full">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-rose-50 border border-rose-200 mb-5 mx-auto">
        ...
        <h1 className="text-lg font-bold text-slate-800 mb-2">Admin Panel Error</h1>
        <p className="text-sm text-slate-500 mb-2">
          Something went wrong in the admin panel. Try refreshing or contact the system administrator.
        </p>
        {error.digest && (
